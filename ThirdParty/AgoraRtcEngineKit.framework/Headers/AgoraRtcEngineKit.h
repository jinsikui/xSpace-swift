...
__attribute__((visibility("default"))) @interface AgoraPublisherConfiguration : NSObject __deprecated;
...
__attribute__((visibility("default"))) @interface AgoraPublisherConfigurationBuilder : NSObject __deprecated;
...
- (void)rtcEngine:(AgoraRtcEngineKit *)engine publishingRequestReceivedFromUid:(NSUInteger)uid;
- (void)rtcEngine:(AgoraRtcEngineKit *)engine publishingRequestAnsweredByOwner:(NSUInteger)uid accepted:(BOOL)accepted error:(AgoraErrorCode)error;
- (void)rtcEngine:(AgoraRtcEngineKit *)engine unpublishingRequestReceivedFromOwner:(NSUInteger)uid;
@end
 ...
 */
+ (instancetype)sharedEngineWithAppId:(NSString*)AppId
                  error:(void(^)(AgoraErrorCode errorCode))errorBlock __deprecated;

+ (void)destroy;

- (void)setEngineDelegate:(id<AgoraRtcEngineDelegate>)delegate;
...
- (void)rtcStatsBlock:(void(^)(AgoraChannelStats* stat))rtcStatsBlock __deprecated;
- (void)leaveChannelBlock:(void(^)(AgoraChannelStats* stat))leaveChannelBlock __deprecated;
- (void)audioQualityBlock:(void(^)(NSUInteger uid, AgoraNetworkQuality quality, NSUInteger delay, NSUInteger lost))audioQualityBlock __deprecated;
- (void)networkQualityBlock:(void(^)(NSUInteger uid, AgoraNetworkQuality txQuality, AgoraNetworkQuality rxQuality))networkQualityBlock __deprecated;
- (void)lastmileQualityBlock:(void(^)(AgoraNetworkQuality quality))lastmileQualityBlock __deprecated;
 ...
 */
- (int)leaveChannel:(void(^)(AgoraChannelStats* stat))leaveChannelBlock;
...
- (int)publishUrl:(NSString *)url transcodingEnabled:(BOOL) transcodingEnabled;

- (int)unpublishUrl:(NSString *)url;
